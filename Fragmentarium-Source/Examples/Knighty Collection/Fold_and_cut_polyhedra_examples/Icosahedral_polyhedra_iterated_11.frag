...
float DE(vec3 z)
{
	...
	for(int i=0; i<Iterations; i++){
		...
		t=dot(z,n2); if (t>0.0) { z-=2.0*t*n2; }
		z = abs(z);
if (i<2) orbitTrap = min(orbitTrap, abs(vec4(z.xyz,dot(z,z))));
...
Up = 0.789384,0.37827,0.482775
AntiAlias = 1
AntiAliasBlur = 1
Detail = -3.65218
MaxStep = -0.3
DetailNormal = -2.56095
DetailAO = -0.42
FudgeFactor = 0.32941
MaxRaySteps = 146
MaxRayStepsDiv = 1.8
...
Up = -0.934127,0.347644,0.0807557
AntiAlias = 1
AntiAliasBlur = 1
Detail = -2.67827
MaxStep = 0.38
DetailNormal = -2.81708
DetailAO = -0.28
FudgeFactor = 1
MaxRaySteps = 56
MaxRayStepsDiv = 1.8
